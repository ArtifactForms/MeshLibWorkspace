...
public class UiCheckBox extends UiComponent {
	...
	public void onDraw(Graphics g) {
		...
		g.fillRect(insets.left, insets.top, width - insets.getWidth() - 1, height - insets.getHeight() - 1);
		...
		g.setColor(foreground);
		g.fillRect(insets.left + offsetX, insets.top + offsetY, width - insets.getWidth() - 1 - (2 * offsetX),
